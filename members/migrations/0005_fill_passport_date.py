...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for membership in orm.TWAMembership.objects.all():
            membership.passport_date = membership.date
            membership.save()
    ...
    models = {
        ...
        'members.news': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 16, 11, 57, 28, 282235)'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
