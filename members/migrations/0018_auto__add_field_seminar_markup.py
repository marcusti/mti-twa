...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Seminar.markup'
        db.add_column('members_seminar', 'markup', self.gf('django.db.models.fields.CharField')(default='text', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Seminar.markup'
        db.delete_column('members_seminar', 'markup')
    ...
    models = {
        ...
        'members.news': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 19, 8, 43, 14, 367841)'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'members.page': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 19, 8, 43, 14, 366270)'}),
