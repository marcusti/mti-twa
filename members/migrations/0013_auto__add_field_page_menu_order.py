...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('members_page', 'menu_order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.menu_order'
        db.delete_column('members_page', 'menu_order')
    ...
    models = {
        ...
        'members.news': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 23, 14, 13, 18, 854459)'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'members.page': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 23, 14, 13, 18, 853000)'}),
