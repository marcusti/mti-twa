...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('members_page', 'markup', self.gf('django.db.models.fields.CharField')(default='text', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.markup'
        db.delete_column('members_page', 'markup')
    ...
    models = {
        ...
        'members.news': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 16, 15, 11, 24, 873115)'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'members.page': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 16, 15, 11, 24, 871529)'}),
