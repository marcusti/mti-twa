...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Seminar.title_en'
        db.add_column('members_seminar', 'title_en', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Seminar.title_ja'
        db.add_column('members_seminar', 'title_ja', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Seminar.text_en'
        db.add_column('members_seminar', 'text_en', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Seminar.text_ja'
        db.add_column('members_seminar', 'text_ja', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Seminar.photo'
        db.add_column('members_seminar', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Seminar.title_en'
        db.delete_column('members_seminar', 'title_en')

        # Deleting field 'Seminar.title_ja'
        db.delete_column('members_seminar', 'title_ja')

        # Deleting field 'Seminar.text_en'
        db.delete_column('members_seminar', 'text_en')

        # Deleting field 'Seminar.text_ja'
        db.delete_column('members_seminar', 'text_ja')

        # Deleting field 'Seminar.photo'
        db.delete_column('members_seminar', 'photo')
    ...
    models = {
        ...
        'members.attachment': {
            ...
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'seminar': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['members.Seminar']", 'null': 'True', 'blank': 'True'})
        },
        'members.country': {
        ...
        'members.news': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 20, 14, 26, 13, 437746)'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'members.page': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 20, 14, 26, 13, 434201)'}),
            'title_en': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'title_ja': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'})
        },
        'members.person': {
        ...
        'members.seminar': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['members.Country']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 11, 20)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 11, 20)'}),
            'teacher': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'teacher'", 'null': 'True', 'to': "orm['members.Person']"}),
            'text': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'text_en': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'text_ja': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'title_en': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'title_ja': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'venue': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'})
        },
