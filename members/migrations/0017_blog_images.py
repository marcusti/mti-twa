...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for news in orm.News.objects.all():
            if news.photo and news.photo.name:
                if not news.photo.name.startswith('images/blog/'):
                    news.photo.name = news.photo.name.replace('images/', 'images/blog/', 1)
                    news.save()

    def backwards(self, orm):
        for news in orm.News.objects.all():
            if news.photo and news.photo.name:
                if news.photo.name.startswith('images/blog/'):
                    news.photo.name = news.photo.name.replace('images/blog/', 'images/', 1)
                    news.save()
    ...
    models = {
        ...
        'members.news': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 19, 3, 48, 49, 471052)'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'members.page': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 19, 3, 48, 49, 469644)'}),
        ...
        'members.seminar': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 12, 19)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
