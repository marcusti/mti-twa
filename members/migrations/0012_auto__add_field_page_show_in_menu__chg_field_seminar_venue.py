...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.show_in_menu'
        db.add_column('members_page', 'show_in_menu', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Changing field 'Seminar.venue'
        db.alter_column('members_seminar', 'venue', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Page.show_in_menu'
        db.delete_column('members_page', 'show_in_menu')

        # Changing field 'Seminar.venue'
        db.alter_column('members_seminar', 'venue', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        'members.news': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 23, 14, 5, 27, 489522)'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'members.page': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 23, 14, 5, 27, 488097)'}),
        ...
        'members.seminar': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 11, 23)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 11, 23)'}),
