...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attachment.seminar'
        db.add_column('members_attachment', 'seminar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['members.Seminar'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Attachment.seminar'
        db.delete_column('members_attachment', 'seminar_id')
    ...
    models = {
        ...
        'members.news': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 20, 14, 8, 46, 94207)'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'members.page': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 20, 14, 8, 46, 93094)'}),
            'title_en': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'title_ja': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'})
        },
        'members.person': {
