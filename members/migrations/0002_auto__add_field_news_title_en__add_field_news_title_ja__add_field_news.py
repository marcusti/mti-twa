...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('members_news', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'News.title_ja'
        db.add_column('members_news', 'title_ja', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'News.preview_en'
        db.add_column('members_news', 'preview_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'News.preview_ja'
        db.add_column('members_news', 'preview_ja', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'News.text_en'
        db.add_column('members_news', 'text_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'News.text_ja'
        db.add_column('members_news', 'text_ja', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'News.title_en'
        db.delete_column('members_news', 'title_en')

        # Deleting field 'News.title_ja'
        db.delete_column('members_news', 'title_ja')

        # Deleting field 'News.preview_en'
        db.delete_column('members_news', 'preview_en')

        # Deleting field 'News.preview_ja'
        db.delete_column('members_news', 'preview_ja')

        # Deleting field 'News.text_en'
        db.delete_column('members_news', 'text_en')

        # Deleting field 'News.text_ja'
        db.delete_column('members_news', 'text_ja')
    ...
    models = {
        ...
        'members.news': {
            ...
            'preview_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'preview_ja': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 5, 9, 43, 59, 703125)'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'text_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'text_ja': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'title_en': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'title_ja': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        'members.person': {
