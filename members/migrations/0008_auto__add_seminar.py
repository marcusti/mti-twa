...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('members_seminar', (
            ...
            ('venue', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ('city', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['members.Country'])),
            ('teacher', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='teacher', null=True, to=orm['members.Person'])),
            ('start_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 11, 20))),
            ('end_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 11, 20), null=True, blank=True)),
        ))
        db.send_create_signal('members', ['Seminar'])


    def backwards(self, orm):
        
        # Deleting model 'Seminar'
        db.delete_table('members_seminar')
    ...
    models = {
        ...
        'members.news': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 20, 14, 8, 10, 565425)'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'members.page': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 20, 14, 8, 10, 564387)'}),
            'title_en': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'title_ja': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'})
        },
        'members.person': {
