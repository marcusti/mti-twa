...
class LicenseManager(models.Manager):
    ...
    def get_granted_licenses(self):
        ...
        return self.get_query_set().filter(status=LICENSE_STATUS_LICENSED, is_active=True, public=True, person__is_active=True, person__public=True, person__twamembership__status__exact=MEMBERSHIP_STATUS_MEMBER).order_by('-date', '-id')
