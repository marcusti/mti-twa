...
#    ( r'^$', 'index' ),
    ...
    ( r'^member-requests/dojo/(\d+)/$', 'member_requests2' ),
    ( r'^member-requests/open/$', 'member_requests2_open' ),
    ( r'^member-requests/open/dojo/(\d+)/$', 'member_requests2_open' ),
    ( r'^member-requests/accepted/$', 'member_requests2_accepted' ),
    ( r'^member-requests/accepted/dojo/(\d+)/$', 'member_requests2_accepted' ),
    ( r'^member-requests/to-be-confirmed/$', 'member_requests2_to_be_confirmed' ),
    ( r'^member-requests/to-be-confirmed/dojo/(\d+)/$', 'member_requests2_to_be_confirmed' ),
    ( r'^member-requests/confirmed/$', 'member_requests2_confirmed' ),
    ( r'^member-requests/confirmed/dojo/(\d+)/$', 'member_requests2_confirmed' ),
