...
urlpatterns += patterns('twa.members.views',
    ...
    (r'^birthdays/$', 'birthdays'),
    (r'^create-teachers-page/$', 'licensees'),
    (r'^teachers/mailinglist/$', 'licensees_mailinglist'),
    ...
    (r'^member-requests/rejected/$', 'member_requests', {'status': '3'}),
