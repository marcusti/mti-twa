...
urlpatterns += patterns('twa.members.views',
    ...
    (r'^news/$', 'news_archive'),
    (r'^news/(\d+)/$', 'news'),
    (r'^news/archive/$', 'news_archive'),
    (r'^news/archive/(\d+)/$', 'news_archive'),
    (r'^news/preview/(\d+)/$', 'news_preview'),
    (r'^nominations-xls$', 'nominations_xls'),
    (r'^seminar/(\d+)/$', 'seminar'),
    (r'^seminars/current/$', 'seminars_current'),
    (r'^seminars/$', 'seminar_archive'),
    (r'^seminars/(\d+)/$', 'seminar_archive'),
